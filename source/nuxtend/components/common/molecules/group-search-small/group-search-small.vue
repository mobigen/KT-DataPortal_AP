  ...
  <div class="text-input-group text-input-group--lg">
    ...
    <div class="combo-box" :class="isComboBoxShow ? 'combo-box--open' : ''">
      ...
      <ul class="autocomplete">
        ...
        <li class="autocomplete__item" value="1">
          <a href="" class="autocomplete__link" target="_blank" title="바로검색하기"
            >아<strong class="autocomplete__title">스</strong>파라거<strong class="autocomplete__title">스</strong></a
          >
        </li>
      </ul>
    </div>
...
import BaseButton from "@project/kt/atoms//base-button/base-button.vue";
import BaseInput from "@project/kt/atoms//base-input/base-input";
import BaseTag from "@project/kt/atoms//base-tag/base-tag";
