<template lang="html">
  <div class="text-input-group text-input-group--lg">
    ...
    <base-button
      title="검색"
      class="text-input-group__search-button button--icon button--lg button--tertiary"
    >
      <svg-icon
        class="svg-icon button__icon"
        name="search"
        aria-hidden="true"
      ></svg-icon>
    </base-button>
        ...
        <ul class="recent-search__list">
          ...
          >
            <div class="keyword">
              ...
              <base-button
                class="keyword__button button--link button--sm button--icon"
                title="삭제"
              >
                <svg-icon
                  class="svg-icon"
      ...
      <ul class="autocomplete">
        <li class="autocomplete__item" value="1">
          <a
            ...
            title="바로검색하기"
          >
            <strong class="autocomplete__title">스</strong>
          </a>
        </li>
