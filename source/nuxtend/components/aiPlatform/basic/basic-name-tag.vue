...
import AtomsWideNameTag from "@/components/aiPlatform/basic/atoms-wide-name-tag.vue";
import AtomsNarrowNameTag from "@/components/aiPlatform/basic/atoms-narrow-name-tag.vue";
