    ...
    <div class="header" :class="width < 1024 ? 'header-mobile' : ''">
      <div class="header__inner">
        ...
        <div class="gnb-area">
          <div class="top-bar">
            <ul class="top-menu">
              <li class="top-menu__item"><NuxtLink to="/" class="top-menu__link" href="#">홈</NuxtLink></li>
          ...
          <nav class="nav" :class="isMobileGnbOpen ? 'nav--open' : ''" @mouseleave="isLnbOpen = false">
            ...
            <ul class="gnb">
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/katech/search" class="gnb__link"><span>데이터 검색</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터 통합검색</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터맵 검색</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-keyword" class="lnb__link">연관관계 검색</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/katech/search" class="gnb__link"><span>데이터 등록</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터 등록</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터 일괄등록 요청</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/katech/search" class="gnb__link"><span>데이터 분석활용</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터 활용사례</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터 분석 시각화</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-keyword" class="lnb__link">데이터 분석 요청</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-keyword" class="lnb__link">데이터 분석 도구</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/katech/search" class="gnb__link"><span>커뮤니티</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터 분석 경진대회</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터 교육</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/katech/search" class="gnb__link"><span>이용안내</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">공지사항</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">FAQ</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-keyword" class="lnb__link">문의하기</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/katech/search" class="gnb__link"><span>마이페이지</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">마이디스크</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-map" class="lnb__link">데이터 활용관리</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-keyword" class="lnb__link">관심/등록 데이터</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-keyword" class="lnb__link">문의내역</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/katech/search-keyword" class="lnb__link">개인정보 관리</NuxtLink>
                  </li>
                </ul>
              </li>
            </ul>
...
import BaseInput from "@katech/atoms/base-input/base-input";
