        ...
        menuList: [
          ...
          },
          {
            ...
            children: [
              ...
              { menuName: "데이터 교육", url: "/portal/ui/board/community/dataEducation" },
              { menuName: "기업지원", url: "/portal/ui/board/community/corporateSupport" },
            ]
          },
          {
            menuName: "이용안내",
            ...
            children: [
              { menuName: "공지사항", url: "/portal/ui/board/information/notification" },
              { menuName: "FAQ", url: "/portal/ui/board/information/faq" },
              { menuName: "문의하기", url: "/portal/ui/board/information/qna" },
              { menuName: "서비스안내", url: "/portal/ui/board/information/service" },
              { menuName: "자료실", url: "/portal/ui/board/information/archieve" },
              { menuName: "ckeditor", url: "/portal/ui/board/information/ckeditor" },
              { menuName: "시각화검색", url: "/portal/ui/board/information/mapSearch" },
            ]
          },
        ],
        /* 임시로 url, icon 설정 */
