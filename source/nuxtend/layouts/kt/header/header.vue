          ...
          <nav class="nav" :class="isMobileGnbOpen ? 'nav--open' : ''" @mouseleave="isLnbOpen = false">
            ...
            <ul class="gnb">
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/kt/search" class="gnb__link"><span>데이터</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/kt/search" class="lnb__link">데이터검색</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/search-map" class="lnb__link">시각화검색</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/registration" class="lnb__link">데이터 신청</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/kt/usage" class="gnb__link"><span>데이터 활용</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/kt/example" class="lnb__link">데이터 활용사례</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/campaign" class="lnb__link">AB캠페인</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/analysis" class="lnb__link">데이터 분석 툴</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/project" class="lnb__link">프로젝트</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/content-register" class="lnb__link">데이터콘텐츠 등록</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/kt/letsdata" class="gnb__link"><span>커뮤니티</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/kt/letsdata" class="lnb__link">Let’s DATA</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/docean" class="lnb__link">D Ocean 협의체</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/kt/notice" class="gnb__link"><span>이용안내</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/kt/notice" class="lnb__link">공지사항</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/faq" class="lnb__link">FAQ</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/inquiry" class="lnb__link">문의하기</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/service" class="lnb__link">서비스 소개</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/reference" class="lnb__link">자료실</NuxtLink>
                  </li>
                </ul>
              </li>
              <li class="gnb__item" @mouseover="isLnbOpen = true">
                <NuxtLink to="/kt/search" class="gnb__link"><span>마이페이지</span></NuxtLink>
                <ul class="lnb">
                  <li class="lnb__item">
                    <NuxtLink to="/kt/my-dashboard" class="lnb__link">대시보드</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/my-wish" class="lnb__link">관심데이터</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/my-usage" class="lnb__link">내 활용내역</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/my-example" class="lnb__link">내 활용사례</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/my-data" class="lnb__link">데이터 신청현황</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/my-inquiry" class="lnb__link">문의내역</NuxtLink>
                  </li>
                  <li class="lnb__item">
                    <NuxtLink to="/kt/my-project" class="lnb__link">프로젝트 관리</NuxtLink>
                  </li>
                </ul>
              </li>
            </ul>
